            ...
            <div style="max-width:560px;margin:0 auto;padding:48px 32px;">
              ...
              <div style="background:#0f1626;border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:40px 36px;margin-bottom:24px;">
                ...
                <p style="margin:0 0 24px;font-size:1rem;color:rgba(255,255,255,.6);line-height:1.7;">
                  Thanks for signing up — you're now on the Kaya early access list for <strong style="color:#fff;">${city}, ${country}</strong>. We'll reach out the moment we launch in your area.
                </p>
              ...
              <div style="background:#0f1626;border:1px solid rgba(255,255,255,.07);border-radius:20px;padding:32px 36px;margin-bottom:24px;">
                ...
                <div style="display:flex;flex-direction:column;gap:12px;">
                  ${[["🍔","Food Delivery","Hot meals from your favourite restaurants"],["🛒","Groceries","Fresh produce and essentials at your door"],["💊","Pharmacy","Medication and health products, fast"],["🛍️","Retail","Shop local stores without leaving home"]].map(([emoji, title, desc]) => `
                  <div style="display:flex;align-items:flex-start;gap:14px;padding:14px 0;border-bottom:1px solid rgba(255,255,255,.05);">
              ...
              <p style="margin:0;font-size:.8rem;color:rgba(255,255,255,.25);text-align:center;line-height:1.6;">
                © 2026 Kaya Technologies Inc. · You're receiving this because you signed up at kaya-sigma.vercel.app
              </p>
            </div>
          </body>
        </html>
