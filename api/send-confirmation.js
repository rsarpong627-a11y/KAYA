              ...
              <div style="max-width:560px;margin:0 auto;padding:48px 32px;">
                ...
                <div style="background:#0f1626;border:1px solid rgba(255,255,255,.07);border-radius:20px;padding:32px 36px;margin-bottom:24px;">
                  ...
                  <div style="display:flex;flex-direction:column;gap:12px;">
                    ${[["Food Delivery","Hot meals from your favourite restaurants"],["Groceries","Fresh produce and essentials at your door"],["Pharmacy","Medication and health products, fast"],["Retail","Shop local stores without leaving home"]].map(([title, desc]) => `
